...
PAGES["equipage.html"] = page(
        ...
        <div class="crew-grid reveal">
          ...
          <article class="crew-card">
            ...
            <div class="crew-card__body">
              ...
              <p class="crew-card__bio">Face à l'imprévu, elle apporte la maîtrise, l'énergie et une endurance mentale à toute épreuve, avec une capacité d'analyse qui, dans une épreuve où tout se joue sur la précision du pilotage, n'a rien d'un détail.</p>
    ...
    <section id="budget">
      <div class="container">
        ...
        <details class="accordion accordion--registration reveal">
          <summary>Que couvrent les frais d'inscription&nbsp;?</summary>
          <div class="accordion__body">
            <ul>
              <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M20 6L9 17l-5-5"/></svg><span><strong>Encadrement &amp; sécurité 24/7 :</strong> 250+ pros, médical complet, 2 hélicoptères, assurance rapatriement, assistance mécanique incluse.</span></li>
              <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M20 6L9 17l-5-5"/></svg><span><strong>Vie au bivouac :</strong> pension complète (buffets faits maison + rations midi), eau, douches, espace détente, carburant fourni, engagement ISO 14001.</span></li>
              <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M20 6L9 17l-5-5"/></svg><span><strong>Communication &amp; visibilité :</strong> téléphone + mails au bivouac, suivi LIVE, fiche équipage en ligne avec logos sponsors, photos quotidiennes + photo HD sous l’arche.</span></li>
              <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M20 6L9 17l-5-5"/></svg><span><strong>Événements inclus :</strong> départ officiel, demi-journée Cœur de Gazelles, arrivée à Essaouira avec soirée de clôture et 2 nuits d’hébergement.</span></li>
              <li><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3"><path d="M20 6L9 17l-5-5"/></svg><span><strong>Accompagnement :</strong> suivi personnalisé en amont + gilet officiel des Gazelles offert.</span></li>
            </ul>
          </div>
        </details>
...
PAGES["le-rallye.html"] = page(
    ...
    <section class="section-alt" id="edition-2027">
      <div class="container">
        <div class="reveal" style="margin-bottom:var(--space-10)">
          ...
          <p class="section-lead">Une aventure qui se joue en 3 actes</p>
        </div>
        ...
        <details class="accordion reveal">
          ...
          <div class="accordion__body">
            <ul class="agenda">
              <li><span class="agenda__date">Jeudi 25 mars</span> Accompagnement de la caravane Cœur de Gazelles et remise des dons. <span class="agenda__aside"><a href="solidarite.html#coeur-de-gazelles">En savoir plus sur Coeur de gazelles</a></span></li>
        ...
        <div class="pledge reveal" style="margin-top:var(--space-6)">
          <h3>La soirée de gala</h3>
          <p>Les partenaires de la formule La Totale sont conviés à la soirée de gala.</p>
          <div class="actions" style="margin-top:var(--space-6)">
            <a href="sponsors.html#formules" class="btn btn-outline">Voir les formules de sponsoring</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="histoire">
      <div class="container">
        ...
        <div class="tl-carousel reveal" data-carousel aria-roledescription="carrousel" aria-label="Frise historique du rallye depuis 1990">
          <button class="tl-carousel__arrow tl-carousel__arrow--prev" type="button" data-carousel-prev aria-label="Jalon précédent">
          ...
          <div class="tl-carousel__viewport">
            <ul class="tl-carousel__track">
              <li class="tl-carousel__slide"><div class="tl-carousel__year">1990</div><h3 class="tl-carousel__title">La première édition</h3><p class="tl-carousel__text">Vingt-sept pionnières au départ, en Lada Niva.</p></li>
              <li class="tl-carousel__slide"><div class="tl-carousel__year">2001</div><h3 class="tl-carousel__title">La caravane médicale</h3><p class="tl-carousel__text">Création de Cœur de Gazelles · suivi satellite IRITRACK.</p></li>
              <li class="tl-carousel__slide"><div class="tl-carousel__year">2009</div><h3 class="tl-carousel__title">Les Armoiries du Royaume</h3><p class="tl-carousel__text">Accordées par Sa Majesté le Roi Mohammed VI.</p></li>
              <li class="tl-carousel__slide"><div class="tl-carousel__year">2010</div><h3 class="tl-carousel__title">La certification ISO 14001</h3><p class="tl-carousel__text">Maintenue sans interruption depuis 2010.</p></li>
              <li class="tl-carousel__slide"><div class="tl-carousel__year">2017</div><h3 class="tl-carousel__title">La catégorie E-Gazelle</h3><p class="tl-carousel__text">Une première mondiale en rallye-raid pour les véhicules électriques.</p></li>
              <li class="tl-carousel__slide"><div class="tl-carousel__year">2021</div><h3 class="tl-carousel__title">Le Prix Gazelles Solidaires</h3><p class="tl-carousel__text">10&nbsp;000&nbsp;€ versés chaque année à une association portée par un équipage.</p></li>
              <li class="tl-carousel__slide"><div class="tl-carousel__year">2023</div><h3 class="tl-carousel__title">La COP 28</h3><p class="tl-carousel__text">Participation de l'organisation aux travaux sur le climat.</p></li>
              <li class="tl-carousel__slide"><div class="tl-carousel__year">2026</div><h3 class="tl-carousel__title">La 35<sup>e</sup> édition</h3><p class="tl-carousel__text">Anniversaire — 12 400 participantes depuis les débuts.</p></li>
            </ul>
          </div>
          <button class="tl-carousel__arrow tl-carousel__arrow--next" type="button" data-carousel-next aria-label="Jalon suivant">
          ...
          <div class="tl-carousel__dots" data-carousel-dots role="tablist" aria-label="Choisir un jalon"></div>
        </div>
        <div class="pledge reveal">
      ...
      <div class="container">
        ...
        <div class="table-wrap reveal">
          <table class="spec-table">
            ...
            <tbody>
              <tr><th scope="row">Virement bancaire</th><td>Coordonnées communiquées sur demande — <a href="#contact" data-objet="rib" data-message="Je souhaite devenir sponsor et faire un virement.">nous écrire</a></td></tr>
              <tr><th scope="row">Paiement en ligne</th><td>Formulaire sécurisé HelloAsso</td></tr>
              <tr><th scope="row">Partenariat en nature</th><td>Casques, covering, location du 4x4, prestations — <a href="#contact" data-objet="nature">à définir ensemble</a></td></tr>
            </tbody>
          </table>
        </div>
        ...
        <div class="contact-grid">
          <div class="contact-info reveal">
            ...
            <div class="contact-info__crew">
              <img src="../assets/duo-signature.jpg" alt="Sandra Aversenq et Stéphanie Falco, l'équipage Smile de Gazelles" loading="lazy" />
              <a href="equipage.html" class="btn btn-outline">Découvrir l'équipage</a>
            </div>
          </div>
          <!-- Formulaire branché sur Netlify Forms, même mécanique que la page
               contact : le POST natif suffit sans JavaScript, main.js
               l'intercepte pour afficher la confirmation sans recharger.
               Le nom « sponsoring » sépare ces demandes des messages de
               contact dans l'interface Netlify ; « bot-field » est le piège
               anti-spam et doit rester dans le HTML pour être détecté. -->
          <div>
            <form class="form reveal" name="sponsoring" method="POST" data-netlify="true" data-netlify-honeypot="bot-field" data-contact-form>
              <input type="hidden" name="form-name" value="sponsoring" />
            ...
            <div class="note" data-form-success hidden tabindex="-1" style="margin-top:0">
              ...
              <p>Nous revenons vers vous sous quelques jours — souvent bien plus vite.</p>
            </div>
          </div>
        </div>
      </div>
...
INDEX = document(
    ...
    <section class="section-alt">
      <div class="container">
        <div class="home-crew reveal">
          <div class="home-crew__heading">
            <span class="eyebrow">Smile de Gazelles - #Team 134</span>
            <div class="home-crew__title-row">
              <img class="home-crew__logo home-crew__logo--light" src="assets/logo.png" alt="" aria-hidden="true" />
              <img class="home-crew__logo home-crew__logo--dark" src="assets/logo-dark.png" alt="" aria-hidden="true" />
              <h2>L'alliance de la maîtrise et de l'instinct</h2>
            </div>
          </div>
          ...
          <div class="split__body">
            ...
            <p>Alias « Wonder Sandra », entrepreneuse instinctive et structurée. Elle apporte son leadership naturel et sa réactivité face aux crises de terrain.</p>
            <h3 class="split__subtitle">Stéphanie Falco — 49 ans · Cadre supérieur RH</h3>
            <p>Bercée par le ronflement des 4x4 de son père, elle allie sérénité et sens de la mécanique. Face à l'imprévu, elle apporte la maîtrise, l'énergie, et une endurance mentale à toute épreuve.</p>
